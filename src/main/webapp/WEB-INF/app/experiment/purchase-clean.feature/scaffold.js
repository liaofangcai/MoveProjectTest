...
exports.exporting = {
  template: 'experiment/purchase-clean/purchase-clean.xls',
  fileName: 'purchase-clean'
};
...
exports.doWithRouter = function(router) {
  router.get('/get-current-info', function (request) {
    ...
    //导出数据
    router.get('/export-excel', mark('services', 'commons/export-excel', 'experiment/purchase-clean').on(function (exportXlsSvc, interformationSvc, request) {
