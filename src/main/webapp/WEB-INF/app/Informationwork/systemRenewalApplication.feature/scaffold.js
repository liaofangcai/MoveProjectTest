...
exports.fieldGroups = {
  defaults:['systemRenewalApplicationNo', 'systemRenewalApplicationDate'],
  //申请部门
  remoteAccessApplications:['informationSystemName', 'masterName',
  'address','incidence', {name: 'updateContent',type :'textarea' ,colspan : 2}, 'proposer','applicationDepartment'],
  //审核意见
...
exports.grid = {
    columns: ['systemRenewalApplicationNo', 'proposer','systemRenewalApplicationDate'],
    filterToolbar: true,
    fixedHeader: true,
    numberColumn: true,
    multiple: true,
