...
exports.fieldGroups = {
  ...
  //申请部门
  remoteAccessApplications:['informationSystemName','masterName',
  ...
  //配置查询条件
  filter: [
    'systemRenewalApplicationNo','informationSystemName', {name: 'applicationTime', type: 'date-range'},
    {name: 'applicationDepartment',type: 'date-range'},'identifierPersonnal','identifierTime' ]
};
exports.grid = {
    columns: ['systemRenewalApplicationNo', 'applicationTime','informationSystemName','proposer','applicationDepartment',
