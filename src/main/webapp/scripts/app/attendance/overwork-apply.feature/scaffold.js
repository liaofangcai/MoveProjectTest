define([
    ...
    return {
      ...
      renderers: {
        ...
        modifyType:function(data, param, gridData) {
          var timeTypeMap;
    ...
    handlers: {
      check: function(){
          var me = this,
              ...
              data = grid.getSelected()[0].toJSON(),
              view = me.feature.views['form:check'];
              if ('-2' !== data.flowStatus) {
                  app.error('请选择审批完成的申请单！');
                  return false;
              }
          app.showDialog({
              view: view,
              ...
              buttons: [{
                  ...
                  fn: function() {
                      ...
                      formData.overworkapplyId = data.id;
